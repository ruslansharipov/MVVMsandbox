...
import ru.surfstudio.standard.i_network.HttpCodes
import ru.surfstudio.standard.i_network.error.*
import ru.surfstudio.standard.i_network.network.NetworkErrorHandler
...
open class DebugStandardErrorHandler @Inject constructor(
    ...
    override fun handleHttpProtocolException(e: HttpProtocolException) {
        ...
        } else if (!TextUtils.isEmpty(e.errorMessage)) {
